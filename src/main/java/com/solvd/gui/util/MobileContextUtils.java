...
public class MobileContextUtils implements IDriverPool {
    ...
    public Set<String> getContexts() {
        ...
        return help.performIgnoreException(((ContextAware) driver)::getContextHandles);
    }

    public View getCurrentContext() {
        DriverHelper help = new DriverHelper();
        WebDriver driver = getDriver();
        return View.valueOf(help.performIgnoreException(((ContextAware) driver)::getContext));
    }
